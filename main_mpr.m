    ...
    for PC = 1:1:3
        ...
        for i = 0:1:n_total
            ...
            [ypdf_idle(i+1,:), s_wifi(i+1), s_laa(i+1), aux_matrix, aux_matrix_wifi, aux_matrix_laa,...
                ...
                = feval('mpr', i, n_total-i, simulation_time, PC, xpdf_idle);   % n_wifi, n_laa
...
%         title(strcat('Simulation - timings - Priority Class = ', num2str(PC)));
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % save data in file
        filename = sprintf('MPR_UL_n_0_10_Pxdb20_b50_noise25_%d_PC%d', n_total, PC);
        ...
        save(filename, 'PC', 'meanSINR_totdB', 'n_total', 's_wifi', 's_laa', 'matrix_wifi_succ',...
            'matrix_wifi_coll', 'matrix_laa_succ', 'matrix_laa_coll', 'xpdf_idle', 'matrix_ocr',...
